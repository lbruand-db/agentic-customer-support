...
# MAGIC UC_TOOL_NAMES = ["workspace.agent.customer_subscriptions", "workspace.agent.get_customer_devices", "workspace.agent.get_promotions_info", "workspace.agent.get_billing_info", "workspace.agent.get_devices_info", "workspace.agent.get_plans_info", "workspace.agent.get_promotions_info", "workspace.agent.get_usage_info"]
# MAGIC
...
# MAGIC             index_name="workspace.gold.support_tickets_index",
...
# MAGIC VECTOR_SEARCH_TOOLS.append(
# MAGIC         VectorSearchRetrieverTool(
# MAGIC             index_name="workspace.gold.knowledge_base_index",
# MAGIC             # TODO: specify index description for better agent tool selection
# MAGIC             # tool_description=""
# MAGIC         )
# MAGIC     )
