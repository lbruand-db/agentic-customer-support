...
UC_TOOL_NAMES = ["workspace.agent.customer_subscriptions", "workspace.agent.get_customer_devices", "workspace.agent.get_promotions_info", "workspace.agent.get_billing_info", "workspace.agent.get_devices_info", "workspace.agent.get_plans_info", "workspace.agent.get_promotions_info", "workspace.agent.get_usage_info"]
...
VECTOR_SEARCH_TOOLS.append(
        VectorSearchRetrieverTool(
            index_name="workspace.gold.support_tickets_index",
...
VECTOR_SEARCH_TOOLS.append(
        VectorSearchRetrieverTool(
            index_name="workspace.gold.knowledge_base_index",
            # TODO: specify index description for better agent tool selection
            # tool_description=""
        )
    )
